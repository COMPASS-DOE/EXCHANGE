...
combined_data = read_sheet("https://docs.google.com/spreadsheets/d/1f6nvuvWGHsmb-vOynBUkIgnwAAymbEiXmj92UNUOaFA/edit#gid=1145965819", sheet = 1)
...
#make_map(DAT = ions_data %>% dplyr::select(kit_id, chloride_ppm), VAR = "chloride_ppm", COLOR_LEGEND = "Chloride, ppm") + ggtitle("Surface waters: chloride")
```
